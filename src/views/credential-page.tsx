    ...
    <main className="neon-auth-page">
      <section className="neon-auth-card">
        <div className="neon-auth-panel">
          ...
          <div className="neon-auth-alt-action">
            <p className="neon-auth-alt-label">Just exploring?</p>
            <Link className="neon-auth-guest-button" href="/guest">
              Continue as Guest
            </Link>
            <p className="neon-auth-alt-copy">
              Open the workspace immediately with local browser storage and no
              account.
            </p>
          </div>
          {error ? (
            <p className="neon-auth-status neon-auth-status--error">{error}</p>
          ) : null}
